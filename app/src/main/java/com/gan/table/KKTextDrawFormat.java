...
public class KKTextDrawFormat<T> implements IDrawFormat<T> {


    private Map<String,SoftReference<String[]>> valueMap; //避免产生大量对象

    public KKTextDrawFormat() {
    ...
    public int measureWidth(String s,Paint paint) {

        return DrawUtils.getMultiTextWidth(paint,getSplitString(s));
