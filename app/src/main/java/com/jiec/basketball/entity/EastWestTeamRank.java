...
public class EastWestTeamRank extends CommResponse {
    ...
    private List<TernBean> Eastern;
    private List<TernBean> Western;

    public List<TernBean> getEastern() {
        return Eastern;
    }

    public void setEastern(List<TernBean> Eastern) {
        this.Eastern = Eastern;
        processData(Eastern);
    }

    public List<TernBean> getWestern() {
        return Western;
    }

    public void setWestern(List<TernBean> Western) {
        this.Western = Western;

        processData(Western);
    }

    private void processData(List<TernBean> tern) {
        for (TernBean b : tern) {
            b.setWin_rate();
            b.setAway();
            b.setHome();
        ...
        Collections.sort(tern, new Comparator<TernBean>() {
            @Override
            public int compare(TernBean o1, TernBean o2) {
