...
public class HistoryResponse extends CommResponse {

    SaveBean historyposts;

    public SaveBean getHistoryposts() {
        return historyposts;
    }

    public void setHistoryposts(SaveBean historyposts) {
